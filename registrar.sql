...
8	History of Yerba	YERB101
9	Post Algebra	MATH600
10	Other Course	MISC400
11	Advanced Dungeons & Dragons	DD550
\.
...
SELECT pg_catalog.setval('courses_id_seq', 12, true);
...
SELECT pg_catalog.setval('students_courses_id_seq', 8, true);
